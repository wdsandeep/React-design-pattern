...
import { LargePersonListItem } from "./people/LargePersonaListItem";
...
const products = [
  ...
  },
  {
    name: 'Basketball',
    price: '$10',
    description: 'Just ike the pros use',
    rating: 3.8
  },
  {
    name: 'Running Shoes',
...
function App() {
  return (
    <>
    <NumberedList items={people} resourceName="person" itemComponent={SmallPersonListItem} />
